      ...
      <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4'>
        <div>
          ...
          <p className='text-gray-500 mt-1 text-sm sm:text-base'>
            View comprehensive school statistics and reports
          </p>
        </div>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {topPerformers.length > 0
                ? (
                    topPerformers.reduce((sum, p) => sum + p.averageMarks, 0) /
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
              ...
              <div className='space-y-4'>
                {classDistribution.map((item, index) => (
                  ...
                  >
                    ...
                    <div className='w-full sm:w-24 bg-gray-200 rounded-full h-2 shrink-0'>
                      <div
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Students with highest average marks
            </CardDescription>
          </CardHeader>
          <CardContent>
            {topPerformers.length === 0 ? (
              ...
              <div className='space-y-4'>
                {topPerformers.slice(0, 10).map((performer, index) => (
                  ...
                  >
                    <div className='flex items-center gap-3 min-w-0'>
                      <div className='h-8 w-8 rounded-full bg-green-100 flex items-center justify-center font-bold text-green-600 text-sm shrink-0'>
                        {index + 1}
                      </div>
                      <div className='min-w-0'>
                        <p className='font-medium text-sm sm:text-base truncate'>
