...
const Grades = () => {
  ...
  const filteredGrades = grades.filter(grade => 
    grade.student_id?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Track and manage student academic performance</p>
        </div>
              ...
              {filteredGrades.length === 0 ? (
                ...
                filteredGrades.map((grade) => (
                  <TableRow key={grade._id}>
                    ...
                    <TableCell>{grade.student_id?.rollNumber || 'N/A'}</TableCell>
                    <TableCell>{grade.subject}</TableCell>
                    <TableCell>{grade.marks}/100</TableCell>
                    <TableCell>
